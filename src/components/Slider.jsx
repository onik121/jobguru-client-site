                ...
                <div className='slider-4 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto slider-content'>
                            ...
                            <p className='text-lg mt-4 sub-title'>Embark on a journey to professional success with our comprehensive job-seeking platform, tailored to match your career aspirations seamlessly.</p>
                        </div>
                    </div>
                </div>
            </SwiperSlide>
                ...
                <div className='slider-2 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[800px] mx-auto slider-content'>
                            ...
                            <p className='text-lg mt-4 sub-title'>Empower your career journey with our website, offering tailored opportunities designed to help you navigate your path to success.</p>
                        </div>
                    </div>
                </div>
            </SwiperSlide>
                ...
                <div className='slider-3 slider'>
                    <div className='overlay flex items-center justify-center'>
                        <div className='text-white text-center max-w-[700px] mx-auto slider-content'>
                            ...
                            <p className='text-lg mt-4 sub-title'>Discover a wide array of job opportunities on our platform, designed to cater to your specific career goals and preferences.</p>
                        </div>
                    </div>
                </div>
            </SwiperSlide>
