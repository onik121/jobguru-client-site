        ...
        <div className="min-h-[calc(100vh-390px)] mb-10 flex items-center">
            ...
            <section className='container mx-auto pt-12'>
                <div className='flex items-center gap-x-3'>
                    <h2 className='text-3xl font-medium text-[#3f3f3f]'>My Posted Jobs</h2>
                    <span className='px-3 py-1 text-xs text-white bg-[#7ad2a2] rounded-md mt-1'>{jobs.length} Jobs</span>
                </div>
